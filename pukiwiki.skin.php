...
<?php if (PKWK_ALLOW_JAVASCRIPT && isset($javascript)) { ?> <meta http-equiv="Content-Script-Type" content="text/javascript" /><?php } ?>
 ...
 <link rel="stylesheet" type="text/css" media="screen" href="<?=SKIN_DIR?>pukiwiki.css.php?charset=<?php echo $css_charset ?>" charset="<?php echo $css_charset ?>" />
...
<body>
<?php if(!isset($vars['help'])){ ?>
<div id="header">
 <h1 class="title"><a href="<?=$link['top']?>"><?php echo $page_title ?></a></h1>
...
<?php } // if this page is Rule page, header and navi are hidden ?>
...
<?php } else { ?>
<div id="body" class="nonColumn"><?php echo $body ?></div>
<?php } ?>
